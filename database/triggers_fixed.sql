-- =============================================
-- CORRECTED MariaDB Compatible Triggers
...
DROP TRIGGER IF EXISTS after_order_detail_change;
DROP TRIGGER IF EXISTS after_order_detail_delete_total;
DROP TRIGGER IF EXISTS before_product_insert_update;
...
-- =============================================
-- Trigger: Validate product data before insert
-- =============================================
...
-- =============================================
-- Trigger: Validate product data before update
-- =============================================
...
-- =============================================
-- Trigger: Validate order data (using correct column names)
-- =============================================
...
BEGIN
    ...
    -- Set default order_status (not status)
...
VALUES (1001, 1, 999, 50000); -- Should fail if insufficient stock

-- 2. Test automatic order total calculation
INSERT INTO Order_Details (order_id, product_id, quantity, unit_price) 
VALUES (1001, 1, 2, 50000); -- Should auto-update order total
